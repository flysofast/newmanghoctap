<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMonHoc.master" AutoEventWireup="true" CodeBehind="TrangTaoBVMH.aspx.cs" Inherits="MangHocTap.TrangTaoBVMH" %>
    ...
    <div class="submonhoc">
        ...
        <div class="bodermonhoc">
            <div class="tieudeheader">
                ...
                <asp:Label ID="Label1" runat="server" Visible="true" Text=" >> Tạo bài viết kiến thức"></asp:Label>
            </div>
            <div class="kqmh">
