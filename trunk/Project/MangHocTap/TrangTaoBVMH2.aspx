<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMonHoc.master" AutoEventWireup="true" CodeBehind="TrangTaoBVMH2.aspx.cs" Inherits="MangHocTap.TrangTaoBVMH2" %>
    ...
    <div class="submonhoc">
        ...
        <div class="bodermonhoc">
            <div class="tieudeheader">
                ...
                <asp:Label ID="Label1" runat="server" Visible="true" Text=" >> Đặt câu hỏi"></asp:Label>
            </div>
            <div class="kqmh">
